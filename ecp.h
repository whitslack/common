...
template <size_t L>
static inline mp_limb_t (& ecp_dbl(mp_limb_t (& _restrict R)[3][L], const mp_limb_t (&N)[3][L], const mp_limb_t (&a)[L], const mp_limb_t (&p)[L]))[3][L] {
...
template <size_t L>
static inline mp_limb_t (& ecp_add(mp_limb_t (& _restrict R)[3][L], const mp_limb_t (&N1)[3][L], const mp_limb_t (&N2)[3][L], const mp_limb_t (&a)[L], const mp_limb_t (&p)[L]))[3][L] {
...
template <size_t L>
static inline mp_limb_t (& ecp_mul(mp_limb_t (& _restrict R)[3][L], const mp_limb_t (&n1)[L], const mp_limb_t (&N2)[3][L], const mp_limb_t (&a)[L], const mp_limb_t (&p)[L]))[3][L] {
