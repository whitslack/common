...
template <size_t L>
static inline mp_limb_t (& fp_mul(mp_limb_t (&r)[L], const mp_limb_t (&n1)[L], const mp_limb_t (&n2)[L], const mp_limb_t (&p)[L]))[L] {
...
template <size_t L>
static inline mp_limb_t (& fp_mul_1(mp_limb_t (&r)[L], const mp_limb_t (&n1)[L], mp_limb_t n2, const mp_limb_t (&p)[L]))[L] {
...
template <size_t L>
static inline mp_limb_t (& fp_sqr(mp_limb_t (&r)[L], const mp_limb_t (&n)[L], const mp_limb_t (&p)[L]))[L] {
...
template <size_t L>
static inline mp_limb_t * fp_pow(mp_limb_t (&r)[L], const mp_limb_t (&n)[L], const mp_limb_t (&e)[L], const mp_limb_t (&p)[L]) {
...
template <size_t L>
static inline mp_limb_t (& fp_inv(mp_limb_t (&r)[L], const mp_limb_t (&n)[L], const mp_limb_t (&p)[L]))[L] {
